...
import { send } from "https://deno.land/x/smtp_send/mod.ts";
...
async function sendEmail(emailContent: any) {
  // Envio real via SMTP usando smtp_send
  ...
  if (!smtpHost || !smtpUser || !smtpPass) {
    throw new Error('Configuração SMTP ausente nas variáveis de ambiente');
  }
