      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{summary.totalCompanies}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{summary.activeSubscriptions}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{summary.overdueSubscriptions}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">MRR (Receita Recorrente Mensal)</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${summary.churnRate > 5 ? 'text-red-600' : summary.churnRate > 2 ? 'text-orange-600' : 'text-green-600'}`}>
              ...
              <div className={`p-3 rounded-full ${summary.churnRate > 5 ? 'bg-red-100' : summary.churnRate > 2 ? 'bg-orange-100' : 'bg-green-100'}`}>
                <TrendingDown className={`h-6 w-6 ${summary.churnRate > 5 ? 'text-red-600' : summary.churnRate > 2 ? 'text-orange-600' : 'text-green-600'}`} />
              </div>
            </div>
          </CardContent>
        </Card>
