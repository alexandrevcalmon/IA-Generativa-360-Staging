...
export const AIChatWidget = ({ lessonId, companyId, className }: AIChatWidgetProps) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <Card className="fixed bottom-4 right-4 w-[calc(100vw-2rem)] sm:w-[1185px] h-[calc(100vh-12rem)] sm:h-[685px] max-h-[700px] shadow-xl z-[9999] flex flex-col border-slate-700/50 bg-slate-900">
          {/* Header - Fixed at top */}
          <ChatHeader
            lessonId={lessonId}
